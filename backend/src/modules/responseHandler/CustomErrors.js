...
const CustomErrors = {
  ...
  ACTION_DEACTIVATED: {
    ...
    errorCode: 'ACTION_DEACTIVATED',
    message: 'The action is deactivated!',
  },
  ...
  WRONG_DEALER_DETAILS: {
    statusCode: StatusCodes.UNPROCESSABLE,
    errorCode: 'WRONG_DEALER_DETAILS',
    message: 'Dealer details are wrong',
  },
  USER_HAS_NO_COUNTRY: {
    statusCode: StatusCodes.UNPROCESSABLE,
    errorCode: 'USER_HAS_NO_COUNTRY',
    message: 'User has no country!',
  },
  DOES_NOT_EXIST: {
    statusCode: StatusCodes.UNPROCESSABLE,
  ...
  ORDER_DETAILS_CHANGE: {
    statusCode: StatusCodes.CONFLICT,
    errorCode: 'ORDER_DETAILS_CHANGE',
    message: 'Products data has been changed!',
  },
  ORDER_EDI_ERROR: {
    statusCode: StatusCodes.BAD_REQUEST,
    errorCode: 'ORDER_EDI_ERROR',
    message: 'Bad request',
  },
  SUPPLIER_NOT_FOUND: {
    statusCode: StatusCodes.BAD_REQUEST,
  ...
  DEALER_DISCOUNT_MUST_BE_DIFFERENT_FROM_COUNTRY: {
    statusCode: StatusCodes.CONFLICT,
    errorCode: 'DEALER_DISCOUNT_MUST_BE_DIFFERENT_FROM_COUNTRY',
    message: 'Dealer discount must have different values than country discount',
  },
};
